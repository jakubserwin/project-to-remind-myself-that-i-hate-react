...
const NavBarComponent = () => (
  <div className="flex justify-between items-center w-full py-4">
    ...
    <div className="flex items-center gap-8">
      <ul className="text-gray-900 uppercase font-bold text-sm flex gap-4">
        <li className="cursor-pointer">About us</li>
        <li className="cursor-pointer">The perks</li>
        <li className="cursor-pointer">faq</li>
      </ul>
      <button type="button" className="text-sm font-bold uppercase bg-gray-900 text-white px-5 py-2 rounded-full">Join Spix club</button>
    </div>
  </div>
)
